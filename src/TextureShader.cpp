...
#else
#include <SDL2/SDL.h>#include <GL/glew.h>
#define NO_SDL_GLEXT //SDL_opengl conflicts w/ glew.h without definition
...
bool TextureShader::loadProgram(){
	...
	//Create shaders
	GLuint vertexShader = loadShaderFromFile("shader\\textureVertexShader.vs", GL_VERTEX_SHADER);
	GLuint fragmentShader = loadShaderFromFile("shader\\textureFragmentShader.fs", GL_FRAGMENT_SHADER);
