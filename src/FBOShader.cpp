...
bool FBOShader::loadProgram(){
	...
	GLuint vertexShader = loadShaderFromFile("shader\\FBOTextureShader.vs", GL_VERTEX_SHADER);
	GLuint fragmentShader = loadShaderFromFile("shader\\FBOTextureShader.fs", GL_FRAGMENT_SHADER);
